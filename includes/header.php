...
<div class="header-wrapper">
	<header>
		<div class="top-wrapper">
			...
			<div class="top-brand">
				<a href="https://openzoomuseum.org">
					<div class="image-container">
						<img src="<?= $CLIENT_ROOT ?>/images/layout/openzoomuseum_logo.svg" alt="Open Zoo Museum logo" width="100%">	
					</div>
					
				</a>
				<div class="brand-name">
					<h1>Open Zoo Museum</h1>
					<h2>An Open Network for Zoological Collections</h2>
				</div>
			</div>
		</div>
